             ...
             <div class=" row  gap-2 ">
                ...
                <div class="col-4 shadow p-3 mb-5 bg-body rounded">
                     ...
                     <h3>Informations clients</h3>
                      <form action="http://localhost:8000/commande/add" method="POST" class="">
                        <?php 
                            ...
                            <div class="col ">
                                <div class="mb-3">
                                    ...
                                    <input
                                        type="text"
                                        name="telephone"
                                        value="<?php echo $client==null ? '' : $client->getTelephone(); ?>"
                                        id=""
                                        class="form-control "
                                        placeholder=""
                                        aria-describedby="helpId"
                            ...
                            <div class="col">
                                <div class="mb-3">
                                    ...
                                    <input
                                        ...
                                        name="nomPrenom"
                                        id=""
                                        value="<?php echo $client==null ? '' : $client->getNomPrenom(); ?>"
                                        class="form-control  "
                                        placeholder=""
                                        aria-describedby="helpId"
                                    />
                                ...
                                <div class="col">
                                    <div class="mb-3">
                                        ...
                                        <textarea
                                            ...
                                            name="adresse"
                                            id=""
                                            value="<?php echo $client==null ? '' : $client->getAdresse(); ?>"
                                            class="form-control "
                                            placeholder=""
                                            aria-describedby="helpId"
                                        ></textarea>
                 ...
                 <div class="row gap-2"> 
                       <div class="col-md-5 mb-3">
                            ...
                            <select
                                ...
                                id=""
                            >
                                <option selected value="1">Produit 1</option>
